        ...
        <div className="bg-slate-50 border-slate-400 rounded-xl shadow-lg p-8">
          <FormProvider {...form}>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Full Name" {...field} className="border-2 focus:border-teal-100 focus:ring focus:ring-teal-100 focus:outline-none focus:shadow-lg transition duration-300" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              />
              <Button type="submit" isLoading={isLoading} className="w-full">Create an account</Button>
            </form>
          </FormProvider>
