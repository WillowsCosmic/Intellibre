...
import EBookCover from "/EbookCover.png"
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden bg-linear-to-br from-gray-50 to-gray-100">
        <img
          src={coverImageUrl || EBookCover}
          alt={book.title}
          className="w-full aspect-16/25 object-cover transiton-transform duration-500 group:hover:scale-105"
      ...
      <div className="absolute bottom-0 left-0 right-0 h-3px bg-linear-to-r from-orange-500 via-amber-500 to-rose-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
    </div>
  )
}
