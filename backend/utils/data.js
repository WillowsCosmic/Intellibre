...
export const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Preview your ebook in a clean, read-only format. Adjust font sizes for a comfortable reading experience be",
    icon: BookOpen,
  ...
  },
  {
    ...
    description:
      "Organize all your ebook projects in a personal dashboard. Easily track progress, edit drafts, and manage y",
    icon: Library,
...
export const TESTIMONIALS = [
  ...
  {
    quote: 'I love the customizable templates. I was able to create a beautiful ebook that matches my brand perfe',
    author: 'John Smith',
